...
extension Question {
    static var allCases: [Question] = [
        ...
        Question(tendsToward: .extroversion, "Seeing other people cry can easily make you feel like you want to cry too."),
        Question(tendsToward: .sensing, "You often make a backup plan for a backup plan."),
        Question(tendsToward: .intuition, "You usually stay calm, even under a lot of pressure."),
        Question(tendsToward: .thinking, "At social events, you rarely try to introduce yourself to new people and mostly talk to the ones you already know."),
        Question(tendsToward: .feeling, "You prefer to completely finish one project before starting another."),
        Question(tendsToward: .judging, "You like to use organizing tools like schedules and lists."),
        Question(tendsToward: .percieving, "Even a small mistake can cause you to doubt your overall abilities and knowledge."),
