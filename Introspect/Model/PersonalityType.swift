...
enum PersonalityType: String, Equatable, CaseIterable, Identifiable {
    ...
    enum Group: String, Identifiable, CaseIterable {
        ...
        var description: String {
            ...
            case .analyst:
                return "Fiercely independent, open-minded, strong-willed and imaginative types who often approach things from a utilitarian perspective."
            case .diplomat:
                return "Diplomatic, cooperative, and imaginative people who often play the role of harmonizers in their workplace or social circles."
            case .sentinel:
                return "Highly practical, hardworking, and cooperative types that embrace and create order, security and stability wherever they go."
            case .explorer:
                return "Spontaneous, utilitarian, crafty, and practical types that shine in situations that require quick reaction and ability to think on your feet."
            }
        }
    }
